...
class Opmob(Resource):
    ...
    def post(self):
        ...
        app.logger.info(f'Opmob post by {username.username}')
        ...
        for orders in mainList:
            ...
            try:
                ...
                app.logger.info(f'save to db task done by {username.username} {mainList["invoiceno"]}')
        ...
        html_body_dict = [set([i['customerName'] for i in confirmDetail]), 
                         set([i['invoice_no'] for i in confirmDetail])]
        ...
        html_body_dict = list (html_body_dict)
        try:
            ...
            app.logger.info(e,"Gmail has some problem. Check if Gmail is online or user gmail is alright or XXXXXhmbr gmail has enough space")
            return {"message":"Gmail has some problem. Check if Gmail is online or user gmail is alright or XXXXXhmbr gmail has enough space"},400
            return mainList,200
